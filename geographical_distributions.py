...
class JobsPlacesAddition:
	...
	def assign_workplaces(self, adult_synthetic_population):
		...
		for group in tqdm(individuals.groupby(['JobType', 'WorksAtSameCategory'])):
			...
			place_index = helper.get_probabilistic_place_assignment(individuals_geocode, workplaces_geocode, p_type=self.workplaces_p_type)
	...
	def assign_schools(self, child_synthetic_population):
		...
		school_index = helper.get_probabilistic_place_assignment(individuals_geocode, schools_geocode, p_type=self.schools_p_type)
	...
	def assign_public_places(self, synthetic_population):
		...
		public_places_index = helper.get_probabilistic_place_assignment(individuals_geocode, public_places_geocode, p_type=self.public_places_p_type)
